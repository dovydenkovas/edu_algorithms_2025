...
Выберите действие.
Клиенты:                                          SIM-карты:
  1) зарегистрировать                                7) добавить карту                         13) выдать карту клиенту
  2) снять с обслуживания                            8) удалить карту                          14) вернуть карту оператору
  3) просмотр всех зарегистрированных клиентов       9) просмотр всех имеющихся карт
  4) очистить данные о клиентах                     10) очистить данные о всех SIM-картах      15) открыть базу данных
  5) поиск клиента по номеру паспорта               11) поиск карты по номеру                  16) сохранить базу данных
  6) поиск клиента по ФИО или адресу                12) поиск карты по тарифу                  17) выходу
)===";
